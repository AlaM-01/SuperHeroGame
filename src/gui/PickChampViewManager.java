...
public class PickChampViewManager {
	...
	private void createBackground() {
		Image backgroundImage = new Image(
				"file:///C:/Users/DELL/Desktop/Milestone3swing/Marvel-M2/src/gui/istockphoto-1077386668-170667a%20(1).jpg");
	...
	private void initializeListeners(ChampionPicker champToPick) {
		champToPick.setOnMousePressed(new EventHandler<MouseEvent>() {
			public void handle(MouseEvent event) {
				if (event.getButton().equals(MouseButton.PRIMARY) && checkNot6()) {
