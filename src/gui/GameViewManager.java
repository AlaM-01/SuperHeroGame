...
public class GameViewManager {
	...
	private void createBackground() {
		Image backgroundImage = new Image(
				"file:///C:/Users/DELL/Desktop/Milestone3swing/Marvel-M2/src/gui/space-nebula-galaxy-wallpaper-pr.jpg");
	...
	private HBox DisplayTurnOrder() {
		...
		while (!currentGame.getTurnOrder().isEmpty()) {
			...
			ImageView ChampionImage = new ImageView(c.getURL());
	...
	private FlowPane DisplayTeams(Player player) {
		...
		for (int i = 0; i < player.getTeam().size(); i++) {
			ImageView ChampionImage = new ImageView(player.getTeam().get(i).getURL());
			ChampionImage.setFitHeight(100);
			ChampionImage.setFitWidth(100);
	...
	private VBox currentChampDetails() {
		...
		String details = subScene.ChampDetails(currentGame.getCurrentChampion());
